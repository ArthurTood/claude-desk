...
你提问时它思考，工具运行时它打字，子代理工作时它杂耍，审批权限时它弹卡片，任务完成时它庆祝，你离开时它睡觉。内置三套主题：**Clawd**（像素螃蟹）、**Calico**（三花猫）和 **Corgi**（柯基），支持自定义主题。
...
<table>
  ...
  <tr>
    <td align="center"><img src="assets/gif/corgi-idle.gif" width="80"><br><sub>柯基待机</sub></td>
    <td align="center"><img src="assets/gif/corgi-thinking.gif" width="80"><br><sub>柯基思考</sub></td>
    <td align="center"><img src="assets/gif/corgi-typing.gif" width="80"><br><sub>柯基打字</sub></td>
    <td align="center"><img src="assets/gif/corgi-building.gif" width="80"><br><sub>柯基建造</sub></td>
    <td align="center"><img src="assets/gif/corgi-juggling.gif" width="80"><br><sub>柯基杂耍</sub></td>
    <td align="center"><img src="assets/gif/corgi-conducting.gif" width="80"><br><sub>柯基指挥</sub></td>
  </tr>
</table>
...
- **柯基** 素材由 Arthur ([@ArthurTood](https://github.com/ArthurTood)) 创作，保留所有权利。
- **第三方画师作品**：版权归各自作者所有。
